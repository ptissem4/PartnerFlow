...
const StatCard: React.FC<StatCardProps> = ({ title, value, change, changeType }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 cursor-pointer">
