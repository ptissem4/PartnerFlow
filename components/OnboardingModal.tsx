...
(function() {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex justify-center items-center p-4" onClick={onSkip}>
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-2xl p-6 sm:p-8 transform transition-all relative" role="dialog" aria-modal="true" onClick={e => e.stopPropagation()}>
        <button
            onClick={onSkip}
