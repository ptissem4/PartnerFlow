...
// Securely access environment variables to prevent crashes in browsers.
...
if (!supabaseUrl) {
  console.warn("Supabase URL is not defined. The app will run in demo mode.");
}

if (!supabaseAnonKey) {
  console.warn("Supabase anonymous key is not defined. The app will run in demo mode.");
}
